...
const std::string c_defaultTexNamePrefix = std::string("T_"); //std::string("N3dSTexNAmE_");

const std::string c_defaultMatNamePrefix = std::string("M_");

//const std::string c_defaultMeshNamePrefix = std::string("Noise3dsMesh_");
