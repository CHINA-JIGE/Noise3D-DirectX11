...
void NoiseGeometryMeshGenerator::CreatePlane(float fWidth, float fDepth, UINT iRowCount, UINT iColumnCount, std::vector<N_DefaultVertex>& outVerticeList, std::vector<UINT>& outIndicesList)
{
...
void NoiseGeometryMeshGenerator::CreateBox(float fWidth, float fHeight, float fDepth, UINT iDepthStep, UINT iWidthStep, UINT iHeightStep, std::vector<N_DefaultVertex>& outVerticeList, std::vector<UINT>& outIndicesList)
{
	/*
	Y  |
	|      /  Z
...
void NoiseGeometryMeshGenerator::CreateSphere(float fRadius, UINT iColumnCount, UINT iRingCount, std::vector<N_DefaultVertex>& outVerticeList, std::vector<UINT>& outIndicesList)
{
...
void NoiseGeometryMeshGenerator::CreateCylinder(float fRadius, float fHeight, UINT iColumnCount, UINT iRingCount, std::vector<N_DefaultVertex>& outVerticeList, std::vector<UINT>& outIndicesList)
{
...
void NoiseGeometryMeshGenerator::CreateSkyDome(float fRadiusXZ, float fHeight, UINT iColumnCount, UINT iRingCount, std::vector<N_SimpleVertex>& outVerticeList, std::vector<UINT>& outIndicesList)
{
...
void NoiseGeometryMeshGenerator::CreateSkyBox(float fWidth, float fHeight, float fDepth, std::vector<N_SimpleVertex>& outVerticeList, std::vector<UINT>& outIndicesList)
{
	//Build 6 Quad
	int tmpBaseIndex;
...
inline void NoiseGeometryMeshGenerator::mFunction_Build_A_Quad
