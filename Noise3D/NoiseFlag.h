...
{
	NOISE_GUI_EVENTS_BUTTON_MOUSEDOWN		= 1,
	NOISE_GUI_EVENTS_BUTTON_MOUSEON				= 2,
	NOISE_GUI_EVENTS_BUTTON_MOUSEPRESSED		= 3,
	NOISE_GUI_EVENTS_BUTTON_MOUSEMOVE		= 4,

	NOISE_GUI_EVENTS_SCROLLBAR_SCROLL				= 5,
	NOISE_GUI_EVENTS_SCROLLBAR_BUTTONDOWN = 6,

	NOISE_GUI_EVENTS_TEXTBOX_TEXTCHANGE		= 7,
	NOISE_GUI_EVENTS_TEXTBOX_GETFOCUS			= 8,
	NOISE_GUI_EVENTS_TEXTBOX_LOSTFOCUS			= 9,
	NOISE_GUI_EVENTS_TEXTBOX_MOUSEDOWN		= 10,
