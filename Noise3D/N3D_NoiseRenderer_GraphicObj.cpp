...
void NoiseRenderer::RenderGraphicObjects()
{
	...
	NoiseCamera* const pCamera = m_pFatherScene->GetCamera();
...
void		NoiseRenderer::mFunction_GraphicObj_RenderLine3DInList(NoiseCamera*const pCamera,std::vector<NoiseGraphicObject*>* pList)
{
...
void		NoiseRenderer::mFunction_GraphicObj_RenderPoint3DInList(NoiseCamera*const pCamera,std::vector<NoiseGraphicObject*>* pList)
{
