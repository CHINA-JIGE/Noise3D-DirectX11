...
void NoiseRenderer::RenderAtmosphere()
{
	...
	//...................
	UINT i = 0;
	NoiseCamera* const tmp_pCamera = m_pFatherScene->GetCamera();
	...
	{
		NoiseAtmosphere* const  pAtmo = m_pRenderList_Atmosphere->at(i);
...
void		NoiseRenderer::mFunction_Atmosphere_Fog_Update(NoiseAtmosphere*const pAtmo)
{
...
void		NoiseRenderer::mFunction_Atmosphere_SkyDome_Update(NoiseAtmosphere*const pAtmo, UINT& outSkyDomeTexID)
{
...
void		NoiseRenderer::mFunction_Atmosphere_SkyBox_Update(NoiseAtmosphere*const pAtmo, UINT& outSkyBoxTexID)
{
...
void		NoiseRenderer::mFunction_Atmosphere_UpdateCbAtmosphere(NoiseAtmosphere*const pAtmo, UINT skyDomeTexID, UINT skyBoxTexID)
{
