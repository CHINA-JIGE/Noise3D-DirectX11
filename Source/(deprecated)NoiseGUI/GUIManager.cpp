...
IComponentManager::IComponentManager()
{
	...
	m_pRenderer = nullptr;
	mCurrentTimeStamp = 0;
	m_pChildButtonList		= new std::vector<IButton*>;
	m_pChildTextList			= new std::vector<ITextBox*>;
	m_pChildScrollBarList	= new std::vector<IScrollBar*>;
	m_pChildOscilloscope	= new std::vector<IOscilloscope*>;
}
...
BOOL IComponentManager::Initialize(UINT backBufferWidth, UINT backBufferHeight, IRenderer& refRenderer, Ut::IInputEngine& refInputE, IFontManager& refFontMgr, HWND hwnd)
{
	if (IsInitialized())
	{
...
BOOL IComponentManager::InitButton(IButton& refObject)
{
...
BOOL IComponentManager::InitTextBox(ITextBox& refObject, UINT fontID)
{
	if (refObject.IsInitialized())
	{
...
BOOL IComponentManager::InitScrollBar(IScrollBar & refObject)
{
	if (refObject.IsInitialized())
	{
...
BOOL IComponentManager::InitOscilloscope(IOscilloscope & refObject)
{
	if (refObject.IsInitialized())
	{
		DEBUG_MSG1("Object Has Been Initialized!");
...
void	IComponentManager::SetInputEngine(IInputEngine& refInputE)
{
	m_pInputEngine = &refInputE;
};

void IComponentManager::SetFontManager(IFontManager & refFontMgr)
{
	m_pFontMgr = &refFontMgr;
}

void IComponentManager::SetRenderer(IRenderer & refRenderer)
{
	m_pRenderer = &refRenderer;
};

void	IComponentManager::Update()
{
...
void IComponentManager::SetWindowHWND(HWND hWnd)
{
	mWindowHWND = hWnd;
};

inline void IComponentManager::AddObjectToRenderList(IButton & obj)
{
...
inline void IComponentManager::AddObjectToRenderList(IScrollBar & obj)
{
...
inline void IComponentManager::AddObjectToRenderList(ITextBox & obj)
{
	m_pRenderer->AddObjectToRenderList(*obj.m_pTextDynamic, NOISE_RENDERER_ADDTOLIST_OBJ_TYPE_GUI_OBJECT);
	m_pRenderer->AddObjectToRenderList(*obj.m_pGraphicObj, NOISE_RENDERER_ADDTOLIST_OBJ_TYPE_GUI_OBJECT);
}

inline void IComponentManager::AddObjectToRenderList(IOscilloscope & obj)
{
...
/***********************************************************************
										P R I V A T E
************************************************************************/
void IComponentManager::Destroy()
{
...
void IComponentManager::mFunction_UpdateInputEngineInfo()
{
	//!!!!!!!!!!!!DONT FORGET THIS
...
void IComponentManager::mFunction_ComputeMouseDepth()
{
...
void IComponentManager::mFunction_UpdateButtons()
{
...
void IComponentManager::mFunction_UpdateScrollBars()
{
...
void IComponentManager::mFunction_UpdateTextBoxs()
{
...
void IComponentManager::mFunction_UpdateOscilloscope()
{
...
void IComponentManager::mFunction_UpdateAllInternalGraphicObjs()
{
