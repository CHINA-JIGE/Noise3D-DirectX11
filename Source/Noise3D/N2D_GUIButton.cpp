...
IButton::IButton(UINT(*pFunc)(UINT NoiseGUIEvent))
{
...
void IButton::SetDragableX(BOOL dragableX)
{
	mIsDragableX = dragableX;
}

void IButton::SetDragableY(BOOL dragableY)
{
	mIsDragableY = dragableY;
}

void IButton::SetTexture(NOISE_GUI_BUTTON_STATE btnState, UINT texID)
{
	switch (btnState)
	{
...
void	IButton::mFunction_Update(BOOL isMouseInContainer, N_GUI_MOUSE_INFO& mouseInfo)
{
...
void  IButton::mFunction_UpdateGraphicObject()
{
