...
IScrollBar::IScrollBar(BOOL isHorizontal, float maxValue , float minValue)
{
	m_pEventList					= new std::vector<UINT>;
	m_pGraphicObj_Groove	= new IGraphicObject;
	m_pButtonScrolling		= new IButton;
...
void IScrollBar::SetAlignment(BOOL isHorizontal)
{
...
void IScrollBar::SetTexture_ScrollGroove(UINT texID)
{
	mTextureID_Groove = texID;
}

void IScrollBar::SetTexture_ScrollButton(NOISE_GUI_BUTTON_STATE btnState, UINT texID)
{
	m_pButtonScrolling->SetTexture(btnState, texID);
}

void IScrollBar::SetValue(float val)
{
	mCurrentValue = gFunction_Clampf(val, mRangeMin, mRangeMax);
}

float IScrollBar::GetValue()
{
	return mCurrentValue;
};

void IScrollBar::SetValueRange(float minValue,float maxValue)
{
...
void IScrollBar::SetScrollButtonLength(float btnPixelLength)
{
...
void IScrollBar::SetScrollWheelSpeed(float fSpeed)
{
	mScrollWheelSpeed = fSpeed;
}

void IScrollBar::SetEnabled(BOOL isEnabled)
{
...
void IScrollBar::mFunction_Update(BOOL isMouseInContainer, N_GUI_MOUSE_INFO& mouseInfo)
{
...
void  IScrollBar::mFunction_UpdateGraphicObject()
{
